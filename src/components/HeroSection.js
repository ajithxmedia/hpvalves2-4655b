...
export default class HeroSection extends React.Component {
    render() {
        ...
        let is_horiz = false;
        let is_vert = false;
        let class_name = _.get(section, 'class_name', null);
